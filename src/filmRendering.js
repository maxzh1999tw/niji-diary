...
const MOSAIC_TOP_MARGIN = 35
const MOSAIC_MAIN_TOP = MOSAIC_TOP_MARGIN + MOSAIC_COLOR_SIZE + MOSAIC_VERTICAL_GAP
...
const MOSAIC_CAPTION_TOP = MOSAIC_MAIN_TOP + MOSAIC_MAIN_HEIGHT + MOSAIC_VERTICAL_GAP
...
export const MOSAIC_POLAROID_LAYOUT = Object.freeze({
  ...
  sourceRects: Object.freeze([
    Object.freeze({ x: MOSAIC_TOP_FIRST_X, y: MOSAIC_TOP_MARGIN, width: MOSAIC_COLOR_SIZE, height: MOSAIC_COLOR_SIZE }),
    Object.freeze({ x: MOSAIC_TOP_SECOND_X, y: MOSAIC_TOP_MARGIN, width: MOSAIC_COLOR_SIZE, height: MOSAIC_COLOR_SIZE }),
    Object.freeze({ x: MOSAIC_TOP_THIRD_X, y: MOSAIC_TOP_MARGIN, width: MOSAIC_COLOR_SIZE, height: MOSAIC_COLOR_SIZE }),
  ...
  caption: Object.freeze({ x: MOSAIC_MAIN_X, y: MOSAIC_CAPTION_TOP, width: MOSAIC_MAIN_WIDTH, height: MOSAIC_CAPTION_HEIGHT, fontSize: 36, lineHeight: 44, maxLines: 3, verticalAlign: 'top' }),
