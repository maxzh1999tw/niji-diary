...
export const FILMS = [
  ...
  },
  {
    ...
    artwork: [
      { type: 'circle', layer: 'foreground', cx: 20, cy: 145, radius: 43, fill: 'none', stroke: 'accent', strokeWidth: 13, opacity: 0.56 },
      { type: 'circle', layer: 'foreground', cx: 31, cy: 318, radius: 27, opacity: 0.48 },
      { type: 'circle', layer: 'foreground', cx: 980, cy: 238, radius: 45, fill: 'none', stroke: 'accent', strokeWidth: 14, opacity: 0.56 },
      { type: 'circle', layer: 'foreground', cx: 969, cy: 462, radius: 28, opacity: 0.48 },
      { type: 'path', layer: 'foreground', d: 'M -18 610 C 5 566 31 566 61 610', fill: 'none', stroke: 'accent', strokeWidth: 14, strokeLinecap: 'round', opacity: 0.52 },
      { type: 'path', layer: 'foreground', d: 'M 939 790 C 969 746 995 746 1020 790', fill: 'none', stroke: 'accent', strokeWidth: 14, strokeLinecap: 'round', opacity: 0.52 },
      ...
      { type: 'circle', cx: 132, cy: 1322, radius: 17, fill: 'none', stroke: 'accent', strokeWidth: 8, opacity: 0.5 },
      ...
      { type: 'circle', cx: 895, cy: 1350, radius: 21, fill: 'none', stroke: 'accent', strokeWidth: 9, opacity: 0.5 },
      { type: 'path', d: 'M 300 1372 C 360 1338 420 1404 480 1368 S 600 1340 665 1375', fill: 'none', stroke: 'accent', strokeWidth: 10, strokeLinecap: 'round', opacity: 0.3 },
    ],
  },
  {
    id: 'pink-pop',
