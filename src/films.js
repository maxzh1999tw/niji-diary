...
export const FILMS = [
  {
    ...
    artwork: [],
    artworkByLayout: { [MOSAIC_LAYOUT_ID]: [] },
  },
  {
    id: 'sky-blue',
    supportedLayoutIds: [DEFAULT_LAYOUT_ID, MOSAIC_LAYOUT_ID],
    ...
    artworkByLayout: {
      [MOSAIC_LAYOUT_ID]: [
        ...
        { type: 'circle', layer: 'foreground', cx: 304, cy: 428, radius: 6, opacity: 0.22 },
        { type: 'circle', layer: 'foreground', cx: 350, cy: 1334, radius: 32, fill: 'none', stroke: 'accent', strokeWidth: 8, opacity: 0.3 },
        { type: 'circle', layer: 'foreground', cx: 395, cy: 1380, radius: 48, fill: 'none', stroke: 'accent', strokeWidth: 10, opacity: 0.26 },
        { type: 'circle', layer: 'foreground', cx: 470, cy: 1305, radius: 15, opacity: 0.22 },
        { type: 'circle', layer: 'foreground', cx: 818, cy: 1375, radius: 55, fill: 'none', stroke: 'accent', strokeWidth: 11, opacity: 0.28 },
        { type: 'circle', layer: 'foreground', cx: 930, cy: 1298, radius: 27, fill: 'none', stroke: 'accent', strokeWidth: 8, opacity: 0.3 },
        { type: 'circle', layer: 'foreground', cx: 910, cy: 1395, radius: 16, opacity: 0.22 },
  ...
  },
  {
    ...
    artworkByLayout: {
      [MOSAIC_LAYOUT_ID]: [
        ...
        { type: 'path', layer: 'foreground', d: 'M 332 1342 L 346 1364 L 371 1367 L 353 1385 L 358 1410 L 334 1399 L 312 1412 L 315 1386 L 296 1369 L 321 1365 Z', fill: 'none', stroke: 'accent', strokeWidth: 8, strokeLinejoin: 'round', opacity: 0.36 },
        { type: 'path', layer: 'foreground', d: 'M 665 1405 C 628 1373 647 1334 681 1353 C 715 1319 755 1351 737 1388 C 724 1411 693 1426 665 1405 Z', fill: 'none', stroke: 'accent', strokeWidth: 9, strokeLinejoin: 'round', opacity: 0.38 },
