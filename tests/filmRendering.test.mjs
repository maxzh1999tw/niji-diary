...
assert.deepEqual(mosaicSources.slice(0, 3).map(({ x, y }) => [x, y]), [[42, 35], [383.1875, 35], [724.375, 35]], 'the first three color photos must form one horizontal row')
...
assert.deepEqual(mosaicGeometry.photoCardStyle, { left: '38.31875cqw', top: '34.2cqw', width: '58cqw', height: '72.5cqw' })
assert.deepEqual(mosaicGeometry.photoThumbnailStyle, { left: '38.31875%', top: '22.8%', width: '58%', height: '48.333333%' })
...
assert.equal(mosaicGeometry.captionCardStyle.left, '38.31875cqw')
assert.equal(mosaicGeometry.captionCardStyle.top, '110cqw')
assert.deepEqual(mosaicGeometry.captionThumbnailStyle, { left: '38.31875%', top: '73.333333%', width: '58%', height: '17.533333%' })
