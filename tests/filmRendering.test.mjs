...
assert.deepEqual(mosaicGeometry.photoCardStyle, { left: '37.5cqw', top: '34.2cqw', width: '58.3cqw', height: '72.875cqw' })
assert.deepEqual(mosaicGeometry.photoThumbnailStyle, { left: '37.5%', top: '22.8%', width: '58.3%', height: '48.583333%' })
...
assert.equal(mosaicGeometry.captionCardStyle.left, '37.5cqw')
assert.equal(mosaicGeometry.captionCardStyle.top, '110.3cqw')
assert.deepEqual(mosaicGeometry.captionThumbnailStyle, { left: '37.5%', top: '73.533333%', width: '58.3%', height: '17.533333%' })
