...
assert.equal(mosaicLayout.caption.height, 214, 'the mosaic caption must grow to the vertical color column bottom')
...
assert.equal(mosaicGeometry.captionCardStyle.height, '21.4cqw')
assert.deepEqual(mosaicGeometry.captionThumbnailStyle, { left: '31.8%', top: '78.333333%', width: '64%', height: '14.266667%' })
