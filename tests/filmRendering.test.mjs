...
assert.deepEqual(mosaicSources.slice(0, 3).map(({ x, y }) => [x, y]), [[42, 35], [362, 35], [682, 35]], 'the first three color photos must form one horizontal row')
assert.deepEqual(mosaicSources.slice(3).map(({ x, y }) => [x, y]), [[42, 342], [42, 636], [42, 930], [42, 1224]], 'the final four color photos must stack on the left')
...
assert.deepEqual(mosaicGeometry.photoCardStyle, { left: '36.2cqw', top: '34.2cqw', width: '58cqw', height: '72.5cqw' })
assert.deepEqual(mosaicGeometry.photoThumbnailStyle, { left: '36.2%', top: '22.8%', width: '58%', height: '48.333333%' })
...
assert.equal(mosaicGeometry.captionCardStyle.left, '36.2cqw')
assert.equal(mosaicGeometry.captionCardStyle.top, '110cqw')
assert.deepEqual(mosaicGeometry.captionThumbnailStyle, { left: '36.2%', top: '73.333333%', width: '58%', height: '17.533333%' })
