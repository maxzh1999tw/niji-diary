...
assert.equal(mosaicGeometry.captionCardStyle.top, '116cqw')
assert.deepEqual(mosaicGeometry.captionThumbnailStyle, { left: '4.2%', top: '77.333333%', width: '91.6%', height: '13.533333%' })
