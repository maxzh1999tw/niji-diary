...
assert.equal(mosaicLayout.caption.lineHeight, 56, 'the mosaic caption must leave a measured gap before the lower dashed edge')
...
assert.equal(mosaicGeometry.captionCardStyle['--polaroid-caption-line-height-px'], '56px', 'the mosaic caption line height must come from the canonical layout')
