...
assert.match(appStyles, /\.film-layout-support \{[^}]*flex-direction: column;[^}]*padding-left: 8px;[^}]*border-left: 2px solid #c9bdd6;/, 'film support layouts must use a left divider without a surrounding frame')
