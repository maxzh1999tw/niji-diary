...
assert.match(appStyles, /\.film-layout-support-item \{[^}]*width: 40px;[^}]*min-height: 56px;[^}]*border: 2px solid #c9bdd6;[^}]*background: #f4eff8;[^}]*box-shadow: 2px 2px 0 #c9bdd6;/, 'additional layout thumbnails must be larger and visibly framed')
