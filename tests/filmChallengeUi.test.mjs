...
assert.match(appStyles, /\.film-card-top \{[^}]*gap: 14px;/, 'film previews and support frames must keep a visible separation')
...
assert.match(appStyles, /\.film-layout-support \{[^}]*flex-direction: column;/, 'film support layouts must stack vertically beside the preview')
assert.match(appStyles, /\.film-layout-support > div \{[^}]*flex-direction: column;/, 'film support thumbnails must form a vertical list')
assert.match(appStyles, /\.film-layout-support-item \{[^}]*width: 40px;[^}]*min-height: 56px;[^}]*border: 1px solid #c9bdd6;[^}]*background: #f4eff8;[^}]*box-shadow: 1px 1px 0 #c9bdd6;/, 'additional layout thumbnails must be larger and visibly framed without a heavy border')
assert.match(appStyles, /\.film-layout-support-item \.layout-thumbnail \{[^}]*width: 30px;/, 'additional layout thumbnails must be enlarged inside their support frame')
