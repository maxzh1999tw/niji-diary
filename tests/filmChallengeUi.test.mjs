...
assert.match(appStyles, /\.layout-thumbnail-main, \.layout-thumbnail-sources > i, \.layout-thumbnail-caption \{[^}]*border: 0;[^}]*background: #[a-f\d]+;/, 'only the layout thumbnail outer frame may use an outline')
