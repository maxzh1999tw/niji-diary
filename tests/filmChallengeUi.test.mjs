...
assert.match(appStyles, /\.film-layout-support \{[^}]*align-self: stretch;[^}]*flex-direction: column;[^}]*padding-left: 4px;[^}]*border-left: 1px solid #68636d;/, 'film support layouts must use a full-height dark gray divider without a surrounding frame')
